...
const Statistics = () => {
  ...
  return (
    <div className='ml-[10vh] md:ml-[15vh]'>
        <Modal isOpen={isAddOrderModalOpen || isAddPatientModalOpen} onRequestClose={closeAddOrderModal || closeAddPatientModal}
            ...
            <Tilt tiltMaxAngleY={10} tiltMaxAngleX={10} >
                <div className='border-light-gray border-2 border-opacity-30 p-6 rounded-lg'>
                    <div className='relative w-full h-[80px]'>
                      <Image src='/images/add.png' alt='add' layout='fill' objectFit="contain"/>
                    </div>
                    <div>
                      <div className='flex items-center mt-6'>
                          <h1 className='text-secondary-dark-blue text-base font-bold transition-all duration-200'>Ajout</h1> 
                      </div>
                    </div>
                    <div className='flex flex-col items-center'>
                        <button className="bg-secondary-light-blue text-white py-2 px-4 rounded mb-2 hover:bg-secondary-medium-blue"
                            onClick={openAddPatientModal}>
                                Créer un patient
                        </button>
                        <button className="bg-medium-green text-white py-2 px-4 rounded hover:bg-dark-green"
                            onClick={openAddOrderModal}>
                                Créer une commande
                        </button>
                    </div>
