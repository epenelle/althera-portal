      ...
      <div className="border-light-gray border-2 border-opacity-30 p-6 rounded-lg">
        ...
        <div>
          <div className="flex items-center justify-between mt-6">
            ...
            <span className="border-dark-green text-dark-green font-bold border-[1px] px-5 py-1 rounded-md text-xs">
              maj : {data.maj} j
            </span>
          </div>
        </div>
        <p className="text-dark-gray mt-2 mb-2">
          Nombre actuel :{' '}
          <span className="text-primary-light-blue font-bold">{data.nb}</span>
        </p>
        <div className="flex items-center justify-between mt-4">
          <div className="flex items-center">
            <h1 className="text-primary-dark-blue text-sm font-bold hover:text-secondary-medium-blue">
              Consulter
            </h1>
          </div>
