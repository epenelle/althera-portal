...
const ModifAccount = () => {
  ...
  return (
    <div className="rounded-lg w-3/4 p-8 border-2 border-gray-200 shadow-lg flex flex-col items-center">
        {isPopUpVisible && (
            <PopUp
      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col mb-4">
          <div className="flex items-center mb-2">
            ...
            <input type="text" placeholder={defaultNomClinique} className="ml-4 flex-1 h-12 border border-gray-200 rounded-full text-base px-5" />
          </div>
          <div className="flex items-center mb-2">
            <label className="w-1/3 text-right whitespace-nowrap">Adresse postale : </label>
            <input type="text" placeholder={defaultAdresse} className="ml-4 flex-1 h-12 border border-gray-200 rounded-full text-base px-5" />
          </div>
          <div className="flex items-center mb-2">
            <label className="w-1/3 text-right whitespace-nowrap flex justify-end">Numéro de téléphone : </label>
            <input type="text" placeholder={defaultTelephone} className="ml-4 flex-1 h-12 border border-gray-200 rounded-full text-base px-5" />
          </div>
          <div className="flex items-center mb-2">
            <label className="w-1/3 text-right whitespace-nowrap">Email : </label>
            <input type="email" placeholder={defaultEmail} className="ml-4 flex-1 h-12 border border-gray-200 rounded-full text-base px-5" />
          </div>
        </div>
        <div className="flex justify-center">
          ...
          onClick={() => showPopUp("Les modifications ont bien été enregistrées !", false)}>
