    ...
    <div className="ml-[10vh] md:ml-[15vh]">
      <div className="w-4/5 mx-auto p-6 bg-light-white ">
        ...
        <div className="flex justify-between mt-4">
          <div
            className={`w-1/2 text-center py-2 border-2 border-light-gray rounded-lg cursor-pointer ${activeSection === 'modifCompte' ? 'bg-primary-light-blue' : 'hover:bg-gray-100'} transition duration-300 ease-in-out mr-2`}
            onClick={() => handleSectionClick('modifCompte')}
          >
            Modification des coordonnées
          </div>
          <div
            className={`w-1/2 text-center py-2 border-2 border-light-gray rounded-lg cursor-pointer ${activeSection === 'modifPass' ? 'bg-primary-light-blue' : 'hover:bg-gray-100'} transition duration-300 ease-in-out ml-2`}
