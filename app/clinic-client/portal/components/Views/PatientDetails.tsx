...
const PatientDetails: React.FC<DisplayPProps> = ({ patient }) => {
  const router = useRouter();
  const handleClickPatient = (patientId: number = 0) => {
  ...
  return (
    <div className="flex items-center mb-2">
      ...
      <div
        className="flex flex-row ml-4 h-12 border border-light-gray rounded-full text-base px-5 w-56 items-center"
